...
## Notes & limitations
- Chat history (last 100 messages, and DM history) lives in server memory / `users.json` and resets when the server process restarts (locally) or redeploys (cloud).
